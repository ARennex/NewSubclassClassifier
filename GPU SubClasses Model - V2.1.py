...
## Open Databases
classes = ['lpv','cep','rrlyr','ecl','OSARG']
subclasses = ['clasCep','clasOvertoneCep','t2Cep','t2RVTau','contactBinary','detachedBinary','Mira','SRV','RRab','RRc']
...
def create_matrix(data, N):
    ...
    #This does the normalization - subtracting each point from its predecessor
            ...
            for mode in modes:
                ...
                for train_index, test_index in skf.split(files, Y):
                    ...
                    if mode in ['superclass','both']:
                        ...
                        model.load_weights(modelDirectory + str(modelNum)+".h5")
